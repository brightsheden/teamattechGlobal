# Generated by Django 3.1.2 on 2021-12-03 08:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('milestone', '0007_auto_20211126_1502'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shippingPrice', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
                ('_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('order', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='milestone.order')),
            ],
        ),
    ]
